...
- `godot/scripts/systems/SkillSpecValidator.gd`, `SkillForgeRunHarness.gd`, and `SkillCheckEvaluator.gd` enforce the allowlist, draft deterministic directives, and verify observed outcomes.
