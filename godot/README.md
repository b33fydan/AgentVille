...
- The Forge panel now keeps compact `Run Route:`, `Run Ref:`, run context, lifecycle-aware preview/result headers, `Stage:`, next-step, `Run Receipt:`, and blocked-spec `Forge Drift:` lines plus a compact visible `Run Trail:` label for recent lifecycle stages, while chronological `Run History:` tooltips preserve full receipt and repair details.
