...
- `tools/smoke_skill_forge_work_receipts.gd` exercises sent Forge-authored crew work preserving Forge context in badges, receipts, events, visible run-detail/current-stage/next-step/receipt lines, visible run trails, and day-summary work recaps.
...
- The Forge panel now keeps compact run-detail, current-stage, next-step, receipt, and blocked-spec Drift lines plus a visible run trail for recent lifecycle stages, while tooltip history preserves full receipt and repair details.
